var NativescriptVueDynamo=(function(exports,clone,vuePropertyDecorator,gestures){'use strict';clone=clone&&clone.hasOwnProperty('default')?clone['default']:clone;const componentRouter = async (store, router, routes, appMode, Vue) => {
...
}exports.default=Dynamo$1;exports.install=install;return exports;}({},clone,vuePropertyDecorator,gestures));